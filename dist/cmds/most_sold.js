...
exports.default = function () { return __awaiter(_this, void 0, void 0, function () {
    var spinner, purchases, soldItemsObject, mostSoldItem, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                purchases = _a.sent();
                spinner.stop();
                soldItemsObject = helpers_1.setObjectOfItems(purchases.data, 'item');
                mostSoldItem = helpers_1.reducer(soldItemsObject);
