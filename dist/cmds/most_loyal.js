...
exports.default = function () { return __awaiter(_this, void 0, void 0, function () {
    var spinner, purchases, userPurchasesObject, mostRoyalUser, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                purchases = _a.sent();
                spinner.stop();
                userPurchasesObject = helpers_1.setObjectOfItems(purchases.data, 'user_id');
                mostRoyalUser = helpers_1.reducer(userPurchasesObject);
